texts = {
    'en': {
        ...
        'diary_entries': '<b>📖 Diary Entries</b>\n\n<i>click on an entry to open it:</i>',
        'diary_entry_added': 'Diary entry successfully added!',
        'all_entries_cleared': 'all_entries_cleared',
        ...
        'mood_description': 'add a note:',
        'mood_added': 'Mood note has been added!',
        'add_mood': 'Add note',
        'clear_all_notes': 'Clear',
        'all_notes_cleared': 'all_notes_cleared',
    ...
    'ru': {
        ...
        'diary_entry_added': 'Запись добавлена в дневник',
        ...
        'mood_description': 'добавьте заметку:',
